...
def create_pressed1():
    ...
    for name in names:
        ...
        new_button.place(x=80, y=y_position)
...
def create_pressed2():
    ...
    for name in names:
        new_button = tk.Button(root, text=name, command=lambda n=name: choose_flavor(n))
        new_button.place(x=320, y=y_position)
